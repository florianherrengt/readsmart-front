...
const ReadyForm = ({ formControlProps, isValid, onSave }) =>
  !isValid
    ? <FormControl {...formControlProps} />
    : <InputGroup>
        <FormControl {...formControlProps} />
...
export class UrlForm extends React.Component {
  ...
  _isValid() {
    ...
    return typeof this.props.isValid !== "undefined"
      ? this.props.isValid
      : isUrl(value);
  }
  ...
  render() {
    const formControlProps = {
      ...
      placeholder:
        "Url from Reddit, Medium, Hackernews or RSS... (more sources coming soon)",
          ...
          >
            {!this.props.isLoading
              ? <ReadyForm
                  ...
                  onSave={() => this.props.onSave(this.state.value)}
                />
